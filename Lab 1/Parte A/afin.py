...
def main():
    ...
    while run:
        ...
        if(opcion == 1):
            ...
            texto_encriptado = encriptartexto(texto, a, b)
            ...
            a = int(input("Ingrese el valor de a: "))
            b = int(input("Ingrese el valor de b: "))
            print("Texto desencriptado: " + desencriptartexto(texto, a, b))
        elif(opcion == 3):
            run = False
            break
        else:
...
def encriptartexto(texto, a, b):
    # Encriptar texto con cifrado afin
...
def desencriptartexto(texto_cifrado, a, b):
    # Desencriptar texto con cifrado afin
    ...
    texto_cifrado = eliminar_tildes(texto_cifrado)
    texto_desencriptado = ""
    ...
    for letra in texto_cifrado:
        if letra.isalpha():
            ...
            x = a_inv * (y - b) % m
            texto_desencriptado += alfabeto[x]
        else:
